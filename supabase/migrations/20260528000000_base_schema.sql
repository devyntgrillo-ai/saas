...
-- outcome is fully constrained in 20260529060000_consult_outcome.sql; add early so
-- the attribution trigger below can reference it during initial schema bootstrap.
