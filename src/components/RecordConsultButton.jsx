  ...
  return (
    <div className="px-3 pb-3">
      <button
        ...
        className="flex h-9 w-full items-center justify-center gap-2 rounded-lg bg-primary px-3 text-sm font-semibold !text-white transition hover:bg-primary-700"
      >
